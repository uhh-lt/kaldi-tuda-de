...
def ersetze_jahre(text):
    ...
    begin_t, end_t = finde_ausdruck("((Jahr)|(Jahre)|(Januar)|(Februar)|(März)|(April)|(Mai)|(Juni)|(Juli)|(August)|(September)|(Oktober)|(November)|(Dezember)|(von)|(bis)|(Von)|(Bis)|(um)|(Um)|(seit)|(Seit)|(ab)|(Ab)|(gegründet)|(Gegründet)) 1[0-9]{3} ", text)
    if end_t: 
